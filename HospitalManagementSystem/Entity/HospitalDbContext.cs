...
public class HospitalDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Doctor>().HasData(
            new Doctor { Id = 10001, FirstName = "Patricia", LastName = "Blake", Email = "patblake@gmail.com", PhoneNumber = "0434567890", AddrStreetNumber = "8", AddrStreet = "Waterloo Street", AddrCity = "Sydney", AddrState = "NSW", Password = "password" },
            new Doctor { Id = 10002, FirstName = "Timothy", LastName = "Menhennitt", Email = "timmen@yahoo.com", PhoneNumber = "0445384044", AddrStreetNumber = "44", AddrStreet = "Normans Road", AddrCity = "Ullswater", AddrState = "VIC", Password = "password" },
            new Doctor { Id = 10003, FirstName = "Jonathan", LastName = "Bury", Email = "jbury@hotmail.com", PhoneNumber = "0431938727", AddrStreetNumber = "61", AddrStreet = "Hereford Avenue", AddrCity = "Veitch", AddrState = "SA", Password = "password" },
            new Doctor { Id = 10004, FirstName = "Michael", LastName = "Freeman", Email = "howardthomas@gmail.com", PhoneNumber = "0424243806", AddrStreetNumber = "302", AddrStreet = "Regina Greens", AddrCity = "North Mark", AddrState = "NSW", Password = "password" },
            new Doctor { Id = 10005, FirstName = "Stephanie", LastName = "Walker", Email = "dporter@davis-bowen.biz", PhoneNumber = "0456829556", AddrStreetNumber = "331", AddrStreet = "Martin Turnpike", AddrCity = "Sierraborough", AddrState = "NSW", Password = "password" },
            new Doctor { Id = 10006, FirstName = "Allison", LastName = "Robinson", Email = "pacetim@hotmail.com", PhoneNumber = "0477108964", AddrStreetNumber = "56", AddrStreet = "Oconnor Flat", AddrCity = "Ponceview", AddrState = "TAS", Password = "password" },
            new Doctor { Id = 10007, FirstName = "Jacob", LastName = "Brown", Email = "brooke54@martin.com", PhoneNumber = "0467626654", AddrStreetNumber = "231", AddrStreet = "Craig Rapid", AddrCity = "East Hannah", AddrState = "QLD", Password = "password" },
            new Doctor { Id = 10008, FirstName = "Gary", LastName = "Pierce", Email = "qturner@hotmail.com", PhoneNumber = "0419650199", AddrStreetNumber = "307", AddrStreet = "Monica Inlet", AddrCity = "Valeriechester", AddrState = "ACT", Password = "password" },
            new Doctor { Id = 10009, FirstName = "Sheila", LastName = "Lee", Email = "heathermorales@mills.com", PhoneNumber = "0474645295", AddrStreetNumber = "9", AddrStreet = "Michael Junction", AddrCity = "South Randy", AddrState = "WA", Password = "password" },
            new Doctor { Id = 10010, FirstName = "Timothy", LastName = "Anderson", Email = "kellyschwartz@yahoo.com", PhoneNumber = "0499251707", AddrStreetNumber = "309", AddrStreet = "Burke Unions", AddrCity = "Garciafort", AddrState = "VIC", Password = "password" });

        modelBuilder.Entity<Patient>().HasData(
            new Patient { Id = 20001, FirstName = "Diane", LastName = "Perkins", Email = "gregg.trant@yahoo.com", PhoneNumber = "0418923028", AddrStreetNumber = "256", AddrStreet = "Bryan Avenue", AddrCity = "Minneapolis", AddrState = "TAS", Password = "password" },
            new Patient { Id = 20002, FirstName = "Jacob", LastName = "Villanueva", Email = "nashbrooke@perez-blevins.com", PhoneNumber = "0459609536", AddrStreetNumber = "87", AddrStreet = "Brendan Creek", AddrCity = "Nathanburgh", AddrState = "NSW", Password = "password" },
            new Patient { Id = 20003, FirstName = "Ernest", LastName = "Martinez", Email = "kathycruz@gmail.com", PhoneNumber = "0492550332", AddrStreetNumber = "26", AddrStreet = "Ronald Ferry", AddrCity = "New Patricia", AddrState = "WA", Password = "password" },
            new Patient { Id = 20004, FirstName = "Sheila", LastName = "Bowen", Email = "leeramirez@duffy.net", PhoneNumber = "0437652545", AddrStreetNumber = "240", AddrStreet = "Hill Tunnel", AddrCity = "North Brandonmouth", AddrState = "WA", Password = "password" },
            new Patient { Id = 20005, FirstName = "Alexander", LastName = "Taylor", Email = "dburnett@hotmail.com", PhoneNumber = "0490232432", AddrStreetNumber = "322", AddrStreet = "James Village", AddrCity = "Reedhaven", AddrState = "NT", Password = "password" },
            new Patient { Id = 20006, FirstName = "Michael", LastName = "Johnson", Email = "wmyers@ross.biz", PhoneNumber = "0480774922", AddrStreetNumber = "369", AddrStreet = "Calvin Loop", AddrCity = "Bretttown", AddrState = "NSW", Password = "password" },
            new Patient { Id = 20007, FirstName = "Steven", LastName = "Cohen", Email = "lauren61@castillo.info", PhoneNumber = "0413351145", AddrStreetNumber = "178", AddrStreet = "Mary Valleys", AddrCity = "Kellyport", AddrState = "QLD", Password = "password" },
            new Patient { Id = 20008, FirstName = "Nathan", LastName = "Martin", Email = "robert67@yahoo.com", PhoneNumber = "0444997472", AddrStreetNumber = "461", AddrStreet = "Fernandez Ridge", AddrCity = "New Jillberg", AddrState = "NSW", Password = "password" },
            new Patient { Id = 20009, FirstName = "Jonathan", LastName = "Lewis", Email = "ujohnson@hotmail.com", PhoneNumber = "0456237153", AddrStreetNumber = "403", AddrStreet = "Payne Loaf", AddrCity = "Brandonland", AddrState = "SA", Password = "password" },
